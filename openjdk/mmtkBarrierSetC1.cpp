...
void MMTkBarrierSetC1::generate_c1_runtime_stubs(BufferBlob* buffer_blob) {
  ...
  MMTkRefLoadBarrierCodeGenClosure write_code_gen_cl2;
  _ref_load_barrier_c1_runtime_code_blob = Runtime1::generate_blob(buffer_blob, -1, "write_code_gen_cl2", false, &write_code_gen_cl2);
}
